...
[![GitHub License](https://img.shields.io/github/license/lillink13/yamusic-tui)](https://github.com/lillink13/yamusic-tui/blob/main/LICENSE)
...
```bash
go install github.com/lillink13/yamusic-tui@latest
```

Or just download the binary from the [releases](https://github.com/lillink13/yamusic-tui/releases/latest) page.
